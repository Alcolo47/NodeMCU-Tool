// Virtual Terminal to interact programmatically & asynchronously with a serial terminal
...
function getNextResponse() {
    if (_waitingForInput !== null) {
        throw new Error("concurrency error - receive listener already in-queue");
    }
